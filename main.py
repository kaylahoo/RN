...
parser.add_argument('--img_flist', type=str, default='/home/lab265/lab265/liulu/edge_connect_/datasets/psv_train.flist')#shuffled_train.flist
parser.add_argument('--mask_flist', type=str, default='/home/lab265/lab265/liulu/edge_connect_/datasets/masks.flist')#all.flist
...
parser.add_argument('--render_interval', type=int, default=1000, help='how many steps to save a restoration image')
